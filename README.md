The model is called Sentiment Analysis. It basically is trained on the IMDB Movie Review Dataset, which predict the sentiment of the review given by the user either postive or negative.
